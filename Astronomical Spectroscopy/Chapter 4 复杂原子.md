...
$$
\left\{\sum_{i=1}^{N} \left[ \right]+\sum_{i=1}^{N-1} \sum_{j=1+1}^{N} \frac{e^{2}}{4 \pi \varepsilon_{0}\left({r}{i}-{r}{j}\right)}-E\right\} \psi\left(\mathbf{r}{1} {r}{2} \ldots \mathbf{r}{N}\right)=0
$$
