...
$$
\left\{\sum_{i=1}^{N}\left[-\frac{\hbar^{2}}{2 m} \nabla_{i}^{2}-\frac{Z e^{2}}{4 \pi \varepsilon_{0} r_{i}}\right]+\sum_{i=1}^{N-1} \sum_{j=1+1}^{N} \frac{e^{2}}{4 \pi \varepsilon_{0}\left|\mathbf{r}_{i}-\mathbf{r}_{j}\right|}-E\right\} \psi\left(\mathbf{r}_{1} \mathbf{r}_{2} \ldots \mathbf{r}{N}\right)=0
$$
